...
export class ContactDetailsControllerBase {
  constructor(
  ...
  @common.Post()
  @swagger.ApiCreatedResponse({ type: ContactDetails })
  ...
  async createContactDetails(
    @common.Body() data: ContactDetailsCreateInput
  ...
  @common.Get()
  @swagger.ApiOkResponse({ type: [ContactDetails] })
  @ApiNestedQuery(ContactDetailsFindManyArgs)
  @nestAccessControl.UseRoles({
    resource: "ContactDetails",
    action: "read",
    possession: "any",
  ...
  async contactDetailsItems(
    ...
    const args = plainToClass(ContactDetailsFindManyArgs, request.query);
    return this.service.contactDetailsItems({
      ...args,
      select: {
        id: true,
        createdAt: true,
  ...
  async contactDetails(
    @common.Param() params: ContactDetailsWhereUniqueInput
  ): Promise<ContactDetails | null> {
    const result = await this.service.contactDetails({
      where: params,
      select: {
        id: true,
        createdAt: true,
  ...
  async updateContactDetails(
    @common.Param() params: ContactDetailsWhereUniqueInput,
    @common.Body() data: ContactDetailsUpdateInput
  ): Promise<ContactDetails | null> {
    try {
  ...
  async deleteContactDetails(
    ...
    try {
      return await this.service.deleteContactDetails({
        where: params,
        select: {
          id: true,
          createdAt: true,
