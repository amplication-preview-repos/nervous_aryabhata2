...
export class TestimonialControllerBase {
  ...
  async uploadClientImage(
    @common.Param()
    params: TestimonialWhereUniqueInput,
    @common.UploadedFile()
    file: Express.Multer.File
  ): Promise<Testimonial> {
    return this.service.uploadClientImage(
      {
        where: params,
      },
      Object.assign(file, {
  ...
  async downloadClientImage(
    ...
    const result = await this.service.downloadClientImage({
      where: params,
    });
  ...
  async deleteClientImage(
    @common.Param()
    params: TestimonialWhereUniqueInput
  ): Promise<Testimonial> {
    return this.service.deleteClientImage({
      where: params,
    });
  }
}
